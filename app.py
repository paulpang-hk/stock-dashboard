...
targets = {
    ...
    "匯豐控股 (0005)": ("0005.HK", 164.0),
    "中國海洋石油 (0883)": ("0883.HK", 22.5),  # 👈 直接在這裡設定目標價 (例如 24.0)
    "中國移動 (0941)": ("0941.HK", 73.0),       # 👈 直接在這裡設定目標價 (例如 85.0)
    "騰訊控股 (0700)": ("0700.HK", 430),
    "700 Call (25940)": ("25940.HK", 0.08),
    "700 Call (14254)": ("14254.HK", 0.08),
    "005 Bull (54672)": ("54672.HK", 0.03),
    "005 Bull (56302)": ("56302.HK", 0.03)
}
